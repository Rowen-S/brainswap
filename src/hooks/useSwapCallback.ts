...
export function swapErrorToUserReadableMessage(error: any): string {
  ...
  switch (reason) {
    ...
    case 'BrainswapRouter: INSUFFICIENT_OUTPUT_AMOUNT':
    case 'BrainswapRouter: EXCESSIVE_INPUT_AMOUNT':
    ...
    case 'Brainswap: TRANSFER_FAILED':
...
export function useSwapCallback(
  ...
  return useMemo(() => {
    ...
    return {
      ...
      callback: async function onSwap(): Promise<string> {
        ...
        const referAndCalldata = routerContract?.interface.encodeFunctionData('referAndCall', [AddressZero, calldata])
  ...
  }, [trade, library, account, chainId, recipient, recipientAddressOrName, swapCalls, routerContract, addTransaction])
}
