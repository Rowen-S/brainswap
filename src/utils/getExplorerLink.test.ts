...
describe('#getExplorerLink', () => {
  ...
  it('mumbai', () => {
    expect(getExplorerLink(8001, 'abc', ExplorerDataType.ADDRESS)).toEqual('https://mumbai.polygonscan.com/address/abc')
  })
  it('unrecognized chain id defaults to mainnet', () => {
    expect(getExplorerLink(2, 'abc', ExplorerDataType.ADDRESS)).toEqual('https://mumbai.polygonscan.com/address/abc')
  })
})
